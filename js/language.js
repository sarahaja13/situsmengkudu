const translations = {
    ...
    id: {
        ...
        heroLine1:"MENGKUDU",
        heroLine2:"INDONESIA",
        heroSubtitle:"SUPPLY TERJAMIN",
        heroDescription:"<b>Kami menyediakan buah mengkudu segar<br>berkualitas tinggi dengan sistem pengelolaan<br>modern dan berkelanjutan.</b>",
        ...
        why2Title: "Standar Kualitas Tinggi",
        why2Desc: "Buah dipilih dengan standar ketat untuk hasil terbaik.",

        why3Title: "Panen Terjadwal",
        why3Desc: "Sistem panen bertahap menjaga kesegaran dan ketersediaan.",

        why4Title: "Kontrol & Supervisi",
        why4Desc: "QC sebelum pengiriman untuk kualitas terjaga.",

        why5Title: "Pengiriman Cepat",
        why5Desc: "Pengiriman maksimal 24 jam setelah panen.",

        why6Title: "Kemitraan Terpercaya",
    ...
    en: {
        ...
        heroLine2:"NONI",
        heroSubtitle:"GUARANTEED SUPPLY",
        ...
        why2Title: "High Quality Standards",
        why2Desc: "Carefully selected fruit with strict quality control.",

        why3Title: "Scheduled Harvest",
        why3Desc: "Staged harvesting ensures freshness and stable supply.",

        why4Title: "Control & Supervision",
        why4Desc: "Quality inspection before shipment.",

        why5Title: "Fast Delivery",
        why5Desc: "Maximum 24 hours after harvest.",

        why6Title: "Trusted Partnership",
    ...
    ko: {
        ...
        why2Title: "높은 품질 기준",
        why2Desc: "엄격한 기준으로 선별된 노니만 제공합니다.",

        why3Title: "계획 수확",
        why3Desc: "신선함과 안정적인 공급을 위한 단계별 수확.",

        why4Title: "품질 관리",
        why4Desc: "출고 전 철저한 품질 검사.",

        why5Title: "신속 배송",
        why5Desc: "수확 후 최대 24시간 이내 발송.",

        why6Title: "신뢰할 수 있는 파트너십",
    ...
    hi: {
        ...
        heroLine2: "नोनी",
        heroSubtitle: " सुनिश्चित आपूर्ति",
        ...
        why2Title: "उच्च गुणवत्ता मानक",
        why2Desc: "सख्त गुणवत्ता नियंत्रण के साथ चुने गए फल।",

        why3Title: "नियोजित फसल",
        why3Desc: "ताज़गी और स्थिर आपूर्ति के लिए चरणबद्ध कटाई।",

        why4Title: "नियंत्रण और निरीक्षण",
        why4Desc: "शिपमेंट से पहले गुणवत्ता जांच।",

        why5Title: "तेज़ डिलीवरी",
        why5Desc: "कटाई के 24 घंटे के भीतर भेजा जाता है।",

        why6Title: "विश्वसनीय साझेदारी",
        ...
        spec3Title: "औसत वजन",
        spec3Value: "160 ग्राम",

        spec4Title: "पैकेजिंग",
        spec4Value: "पीपी प्लास्टिक बैग",
